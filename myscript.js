...
//     var numeroGenerato = Math.floor(Math.random() * NUMERO_MASSIMO) + 1;
...
// while (numeriInseriti.length < (NUMERO_MASSIMO - NUMERO_BOMBE) && !bombaTrovata) {
//     // chiedo all'utente un numero
//     // controllo se l'utente ha già inserito un numero:
//     // se si:mando un messagggio di Errore 
//     // se no: prosegui
//     // controllo se è una bomba 
//     // se si :bombaTrovata = true;
//     // se no: continuo

//     var numeroUtente = parseInt(prompt("Inserisci un numero"));

//     if (numeroInseriti.indexOf(numeroUtente) - 1) {
...
// }
// if (numeriInseriti.length == (NUMERO_MASSIMO - NUMERO_BOMBE)){
